<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MemberEdit.aspx.cs" Inherits="WebPlat.Management.member.MemberEdit" %>
...
<body>
    <form id="form1" runat="server">
          ...
          <table width="100%">
                <tr>
                    <td colspan="4" style="text-align:left;" class="tb">修改成员</td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="4" style="text-align:center;">
                        <asp:Button ID="add" runat="server" Text="修改" class="button_on" OnClick="editMember"/>&nbsp;
