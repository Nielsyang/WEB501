<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddPublication.aspx.cs" Inherits="WebPlat.Management.publication.AddPublication" %>
...
<body>
    <form id="form1" runat="server">
       <div>
            <table width="100%">
                <tr>
                   <td colspan="2" style="text-align:left;" class="tb">添加论文</td>
                </tr>
                <tr>
                ...
                <tr>
                   <td colspan="2" style="text-align:center;">
                       <asp:Button ID="Button1" runat="server" Text="添加" class="button_on" OnClick="addPublication"/>&nbsp;
